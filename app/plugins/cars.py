    ...
    def _get_cars_data():
        ...
        with Client(f"{URL}/api", TOKEN) as client:
            for car_config in cars_config:
                ...
                charging_active_entity = car_config.get('charging_active_entity')
                charging_power_entity = car_config.get('charging_power_entity')
                ...
                car_entry = {
                    ...
                    "charging": True if client.get_entity(entity_id=charging_active_entity).get_state().state == "on" else False,
                    "charging_power": client.get_entity(entity_id=charging_power_entity).get_state().state,
